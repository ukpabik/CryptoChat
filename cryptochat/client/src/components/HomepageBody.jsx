  ...
  return (
    <div>
      <div aria-live="polite" className="ticker">
        <div className="breaking-news">NEWS</div>
        {cryptoNews ? (
            ...
            {!isLoggedIn ? (
              <div className="blur">
                <button
                  ...
                  className="blurtext"
                >
                  <a className="blursignin">
                    Click here to sign in and join the chat.
                  </a>
                </button>
              </div>
            ) : (
                    ...
                    <div key={crypto.id} className="cryptoListElement">
                      ...
                      <li className="cryptoTitle">
                        <span className="nameSpan">
                          <a
                            href={`/crypto/${crypto.name}`}
                            title={crypto.fullName}
                            className="cryptoURL"
                          >
                            {crypto.name}
                          </a>
                        ...
                        {crypto.percent_change_24h > 0 ? (
                          <span className="changeSpan green">
                            {crypto.percent_change_24h.toLocaleString(
                              undefined,
                              {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
